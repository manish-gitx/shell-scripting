...
try:
    name1=soup.find('h2',{'class':'a-size-mini'})
    for ele1 in name1:
        name2=name1.find('a',{'class':'a-link-normal'})
    for ele2 in name2:
        obj["name"]=name2.find('span').text
...
try:
    ...
    for ele in price:
        obj["price"]=price.find('span',{'class':'a-offscreen'}).text.strip()

except:
    obj["price"]=None

try:
    obj1["name"]=soup1.find('p',{'class':'sp__name'}).text

    # for ele in rname:
    #    obj1["name"]=rname.find('p',{'class':'sp__name'}).text
except:
    obj1["name"]=None

try:

    digi1=soup1.find('div',{'class':'Grid__StyledGrid-sc-syw1oe-0'})
    obj1["price"]=digi1.find('span',{'class':'TextWeb__Text-sc-1cyx778-0'}).text
...
print("name of the product in amazon:")
print(obj["name"])
print(obj["price"])
print("name in digital")
print(obj1['name'])
print(obj1['price'])
